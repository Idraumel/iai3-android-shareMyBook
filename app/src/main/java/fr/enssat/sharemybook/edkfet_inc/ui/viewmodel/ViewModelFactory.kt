...
class ViewModelFactory(
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(BookViewModel::class.java) && bookRepository != null && loanRepository != null && authManager != null) {
            @Suppress("UNCHECKED_CAST")
            return BookViewModel(bookRepository, loanRepository, authManager) as T
        }
        ...
        if (modelClass.isAssignableFrom(MyLoansViewModel::class.java) && loanRepository != null && authManager != null) {
            @Suppress("UNCHECKED_CAST")
            return MyLoansViewModel(loanRepository, authManager) as T
        }
        throw IllegalArgumentException("Unknown ViewModel class or repository/manager not provided")
    }
}
